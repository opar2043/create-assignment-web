...
const Register = () => {
  ...
  return (
    <div>
      <div className="hero bg-blue-200 py-4 min-h-screen rounded-md">
            ...
            <form className="card-body" onSubmit={handleSubmit}>
              ...
              <div className="form-control">
                ...
                <input
                  ...
                  className="input input-bordered"
                  defaultValue={"https://i.ibb.co.com/W2fXTxK/clothes3.jpg"}
                  required
                />
              </div>
              ...
              <p className="text-center font-bold">
                ...
                <NavLink className={"text-blue-700 text-lg"} to={"/login"}>
                  Log In
                </NavLink>
              </p>
            </form>
